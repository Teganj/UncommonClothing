...
public class TinyDB {
    ...
    public ArrayList<ClothesList> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ClothesList> playerList =  new ArrayList<ClothesList>();

        for(String jObjString : objStrings){
            ClothesList player  = gson.fromJson(jObjString,  ClothesList.class);
    ...
    public void putListObject(String key, ArrayList<ClothesList> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ClothesList player: playerList){
